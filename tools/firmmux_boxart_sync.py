...
ROM_EXTENSIONS = {
    ...
    "col": {".col", ".rom", ".bin"},
    "c64": {".d64", ".t64", ".prg", ".crt"},
    "c128": {".d64", ".t64", ".prg", ".crt"},
    "vic20": {".d64", ".t64", ".prg", ".crt"},
    "plus4": {".d64", ".t64", ".prg", ".crt"},
    "pet": {".prg", ".d64", ".t64"},
    "cpc": {".dsk", ".sna", ".cdt"},
    "gb": {".gb", ".gbc"},
    "gba": {".gba"},
    ...
    "jaguar": {".j64", ".jag", ".abs", ".cof"},
    "lynx": {".lnx", ".o"},
    "m5": {".rom", ".m5", ".bin"},
    "n64": {".z64", ".n64", ".v64"},
    "nes": {".nes", ".fds", ".unf", ".unif"},
    "neogeo": {".zip", ".7z"},
    "neogeocd": {".cue", ".chd", ".iso", ".bin"},
    "ngp": {".ngp", ".ngc", ".npc"},
    "pc98": {".hdi", ".fdi", ".d88", ".xdf", ".nhd"},
    "pkmni": {".min"},
    "pknmini": {".min"},
